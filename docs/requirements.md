...
|R3 | Functional | Annotate TE seqs from R2 output | DONE | Given the output from R2 (a fasta file), this rule shall annotate those consenus sequences specified by user. | [RepeatMasker](http://www.repeatmasker.org/) |
